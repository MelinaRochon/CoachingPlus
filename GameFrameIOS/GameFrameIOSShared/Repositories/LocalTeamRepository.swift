...
public final class LocalTeamRepository: TeamRepository {

    private var teams: [DBTeam]
    
    public init(teams: [DBTeam]? = nil) {
    ...
    public func getTeamWithAccessCode(accessCode: String) async throws -> DBTeam? {
        guard let team = teams.first(where: { $0.accessCode == accessCode }) else {
    ...
    public func addPlayerToTeam(id: String, playerId: String) async throws {
        ...
        guard !team.players!.contains(playerId) else {
            ...
            throw TeamError.playerAlreadyInTeam
        }
    ...
    public func addCoachToTeam(id: String, coachId: String) async throws {
        ...
        if !team.coaches.contains(coachId) {
            ...
            throw TeamError.coachAlreadyInTeam
        }
    }
    ...
    public func addInviteToTeam(id: String, inviteDocId: String) async throws {
        ...
        if !team.invites!.contains(inviteDocId) {
            ...
            throw TeamError.inviteAlreadySent
        }
    }
    ...
    public func getInviteDocIdOfPlayerAndTeam(teamDocId: String, playerDocId: String) async throws -> String? {
        ...
        throw TeamError.inviteNotFound
    }
    ...
    public func removeInviteFromTeam(id: String, inviteDocId: String) async throws {
        ...
        guard let inviteIdx = teams[index].invites?.firstIndex(where: { $0 == inviteDocId }) else {
            throw TeamError.inviteNotFound
        }
        
        teams[index].invites?.remove(at: inviteIdx)
    }
