...
public struct DBCoach: Codable {
    public let id: String
    public let coachId: String
    public var teamsCoaching: [String]?
    
    // Initializer to create a DBCoach with optional teamsCoaching
    public init(id: String, coachId: String, teamsCoaching: [String]? = nil) {
        self.id = id
    ...
    public init(id: String, coachId: String) {
        self.id = id
        self.coachId = coachId
        self.teamsCoaching = []
    }
    ...
    public init(id: String, coachDTO: CoachDTO) {
        self.id = id
