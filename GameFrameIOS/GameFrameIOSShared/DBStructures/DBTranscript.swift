...
public struct DBTranscript: Codable {
    public let transcriptId: String
    public let keyMomentId: String
    public var transcript: String // transcription
    public let language: String // Language of the transcript - Only english for now
    public let generatedBy: String
    public let confidence: Int
    public let gameId: String
    
    public init(transcriptId: String, keyMomentId: String, transcript: String, language: String, generatedBy: String, confidence: Int, gameId: String) {
    ...
    public init(transcriptId: String, transcriptDTO: TranscriptDTO) {
        self.transcriptId = transcriptId
