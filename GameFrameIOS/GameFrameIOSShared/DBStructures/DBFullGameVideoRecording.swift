 ...
 */
public struct DBFullGameVideoRecording: Codable {
    public let id: String          // The unique identifier of the video recording document.
    public let gameId: String      // The ID of the game that this video recording is related to.
    public let uploadedBy: String  // The ID or username of the person who uploaded the video.
    public var fileURL: String?    // The URL to access the video file (optional because it might not be set yet).
    public let startTime: Date     // The start time of the video recording.
    public var endTime: Date?      // The end time of the video recording (optional because it may not be provided yet).
    public let teamId: String      // The ID of the team associated with the video recording.
    ...
    public init(id: String, fullGameVideoRecordingDTO: FullGameVideoRecordingDTO) {
        self.id = id
