...
public struct UserDTO {
    ...
    public init(userId: String?, email: String, photoUrl: String? = nil, userType: UserType, firstName: String, lastName: String, dateOfBirth: Date? = nil, phone: String? = nil, country: String? = nil) {
        self.userId = userId
        self.email = email
